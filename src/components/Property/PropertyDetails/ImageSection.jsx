    ...
    return (
      <div className="max-w-5xl mx-auto bg-white">
        ...
        <div className="hidden md:flex flex-row gap-2">
          ...
          <div className="w-1/2 grid grid-cols-1 gap-1 md:grid-cols-2 md:grid-rows-2">
              ...
              return (
                <div key={index} className="relative">
                  <img
                    ...
                    className="w-full h-16 md:h-[160px] object-cover rounded-lg"
                  />
                  {isLastImage && (
                    <button
                      onClick={() => setShowAllModal(true)}
